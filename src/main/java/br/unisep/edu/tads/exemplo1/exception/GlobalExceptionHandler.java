...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<?> resourceNotFoundException(ResourceNotFoundException ex, WebRequest request) {
		ErrorResponse detalhes = new ErrorResponse(new Date(), HttpStatus.NOT_FOUND.toString(), ex.getMessage(),
	...
	public ResponseEntity<?> globeExceptionHandler(Exception ex, WebRequest request) {
		ErrorResponse detalhes = new ErrorResponse(new Date(), HttpStatus.INTERNAL_SERVER_ERROR.toString(),
